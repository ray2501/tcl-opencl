...
PKG_SOURCES	=  tclopencl.c
PKG_OBJECTS	=  tclopencl.o
...
PKG_LIB_FILE	= libopencl0.6.so
PKG_LIB_FILE8	= libopencl0.6.so
PKG_LIB_FILE9	= libtcl9opencl0.6.so
PKG_STUB_LIB_FILE = libopenclstub0.6.a
...
top_builddir	= /home/danilo/Public/tcl-opencl
...
CPPFLAGS	= 
LIBS		=  -L/usr/lib64 -lvectclstub0.3 -lOpenCL 
AR		= ar
